...
def options():
    ...
    session.update(hdlc_framing=['no','yes'][random.randint(0, 1)],
                   ...
                   ipv4='1', ipv6=str(random.randint(0, 1)),
    ...
    return (f'''
            ...
            <object ID="ur_Host" CLASSID="CLSID:CC85ACDF-B277-486F-8C70-2C9B2ED2A4E7"
             ...
             WIDTH="320" HEIGHT="240">
                ...
                <IPV4_0>{session['ipv4']}</IPV4_0>
                <IPV6_0>{session['ipv6']}</IPV6_0>
...
# (what the real F5 server responds when it doesn't like the parameters, intended
